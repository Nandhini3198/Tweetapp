...
INSERT INTO user  (`us_first_name`, `us_last_name`, `us_gender`, `us_dob`, `us_email`, `us_password`, `us_isactive`)
 VALUES ('Nandhini', 'Mahadevan', 'Female', '1998-01-03', 'nans@gmail.com', 'password123', '0'),
 ('Sherlock', 'Holmes', 'Male', '1983-01-06', 'sh@gmail.com', 'sh221b', '0');
 
 
 INSERT INTO post(message,us_email)values('I am a huge fan of SH','nans@gmail.com'),('The Game is on','sh@gmail.com');
